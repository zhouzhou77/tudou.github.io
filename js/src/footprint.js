...
var data = [
    ...
    {name: '澳门', value: ['旅游']},
    {name: '海参崴', value: ['旅游']},
    {name: '奥克兰', value: ['新西兰打工度假']},
    {name: '陶朗加', value: ['新西兰打工度假']},
    {name: '惠灵顿', value: ['新西兰打工度假']},
    {name: '基督城', value: ['新西兰打工度假']},
    {name: '皇后镇', value: ['新西兰打工度假']},
    {name: '因弗卡吉尔', value: ['新西兰打工度假']},
    {name: '陶波', value: ['新西兰打工度假']},
    {name: '罗托鲁瓦', value: ['新西兰打工度假']},
    {name: '纳皮尔', value: ['新西兰打工度假']},
    {name: '璜加雷', value: ['新西兰打工度假']},
    {name: '凯里凯里', value: ['新西兰打工度假']},
    {name: '凯塔亚', value: ['新西兰打工度假']}
